...
function Chino {
    ...
    elseif ($usrSignoChi -ieq 'Serpiente') {
    ...
    elseif ($usrSignoChi -ieq 'Caballo') {
        Write-Host 'Caballo'
    ...
    elseif ($usrSignoChi -ieq 'Gallo') {
        Write-Host 'Gallo'
        $res.Text = '
        El año del Gallo, según el horóscopo chino, trae consigo una energía vibrante y llena de entusiasmo. 
    ...
    elseif ($usrSignoChi -ieq 'Perro') {
        Write-Host 'Perro'
        $res.Text = '
        El año del Perro en el horóscopo chino trae consigo una energía protectora y leal. 
